        ...
        <form method="post" action="{{ route('LaravelInstaller::environmentSaveWizard') }}" class="tabs-wrap">
            <div class="tab" id="tab1content">
                ...
                <div class="form-group {{ $errors->has('app_name') ? ' has-error ' : '' }}">
                    ...
                    <input type="text" name="app_name" id="app_name" value="{{old('app_name' , 'Sample App')}}"
                           placeholder="{{ trans
              ...
              <div class="form-group {{ $errors->has('app_url') ? ' has-error ' : '' }}">
                ...
                <input type="url" name="app_url" id="app_url" value="{{old('app_url' , $app->make('url')->to('/'))}}" placeholder="{{ trans('installer_messages
            ...
            <div class="tab" id="tab2content">
                ...
                <div class="form-group {{ $errors->has('database_name') ? ' has-error ' : '' }}">
                    ...
                    <input type="text" name="database_name" id="database_name" value="{{old('database_name')}}" placeholder="{{ trans
                ...
                <div class="form-group {{ $errors->has('database_username') ? ' has-error ' : '' }}">
                    ...
                    <input type="text" name="database_username" id="database_username" value="{{old('database_username')}}" placeholder="{{
                    trans('installer_messages.environment.wizard.form.db_username_placeholder') }}" />
            ...
            <div class="tab" id="tab3content">
              <div class="form-group {{ $errors->has('admin_name') ? ' has-error ' : '' }}">
                ...
                <input type="text" name="admin_name" value="{{old('admin_name')}}" id="admin_name" placeholder="Admin Name" />
              ...
              <div class="form-group {{ $errors->has('admin_email') ? ' has-error ' : '' }}">
                ...
                <input type="text" name="admin_email" value="{{old('admin_email')}}" id="admin_email"
              ...
              <div class="form-group {{ $errors->has('admin_password') ? ' has-error ' : '' }}">
                ...
                <input type="password" name="admin_password" id="admin_email" value=""
